...
def callApiGemini(currID: int, question, numTokens) -> str:
    ...
    result = client.models.generate_content(
                ...
                config=types.GenerateContentConfig(
                    ...
                    system_instruction=[
                        "You are a Computer Science and Python documentation expert.", 
                        "Your task is to answer the given question completely, technically, and in detail.",
                        "Return ONLY a valid JSON with the following keys: 'id': an integer representing the identity of the Question-Answer pair; 'question': a string that will be the given question; 'answer': a string that will be the returned answer.",
